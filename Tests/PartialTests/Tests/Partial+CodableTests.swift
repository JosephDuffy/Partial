                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringA)) == "Value A"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringA)) == "Value A"
                                expect(decodedValue.value(for: \.stringB)) == "Value B"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringA)) == "Value A"
                                expect(decodedValue.value(for: \.stringB)) == "Value B"
                                expect(decodedValue.value(for: \.stringC)) == "Value C"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringB)) == "Value B"
                                expect(decodedValue.value(for: \.stringC)) == "Value C"
                                expect(decodedValue.value(for: \.stringD)) == "Value D"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringC)) == "Value C"
                                expect(decodedValue.value(for: \.stringD)) == "Value D"
                                expect(decodedValue.value(for: \.stringE)) == "Value E"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringD)) == "Value D"
                                expect(decodedValue.value(for: \.stringE)) == "Value E"
                                expect(decodedValue.value(for: \.stringF)) == "Value F"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringE)) == "Value E"
                                expect(decodedValue.value(for: \.stringF)) == "Value F"
                                expect(decodedValue.value(for: \.stringG)) == "Value G"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringF)) == "Value F"
                                expect(decodedValue.value(for: \.stringG)) == "Value G"
                                expect(decodedValue.value(for: \.stringH)) == "Value H"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringG)) == "Value G"
                                expect(decodedValue.value(for: \.stringH)) == "Value H"
                                expect(decodedValue.value(for: \.stringI)) == "Value I"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringH)) == "Value H"
                                expect(decodedValue.value(for: \.stringI)) == "Value I"
                                expect(decodedValue.value(for: \.stringJ)) == "Value J"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringI)) == "Value I"
                                expect(decodedValue.value(for: \.stringJ)) == "Value J"
                                expect(decodedValue.value(for: \.stringK)) == "Value K"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringJ)) == "Value J"
                                expect(decodedValue.value(for: \.stringK)) == "Value K"
                                expect(decodedValue.value(for: \.stringL)) == "Value L"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringK)) == "Value K"
                                expect(decodedValue.value(for: \.stringL)) == "Value L"
                                expect(decodedValue.value(for: \.stringM)) == "Value M"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringL)) == "Value L"
                                expect(decodedValue.value(for: \.stringM)) == "Value M"
                                expect(decodedValue.value(for: \.stringN)) == "Value N"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringM)) == "Value M"
                                expect(decodedValue.value(for: \.stringN)) == "Value N"
                                expect(decodedValue.value(for: \.stringO)) == "Value O"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
                    ...
                    context("the encoded data") {
                        ...
                        it("should be usable to decode Partial<Wrapped>") {
                            do {
                                ...
                                expect(decodedValue.value(for: \.stringN)) == "Value N"
                                expect(decodedValue.value(for: \.stringO)) == "Value O"
                                expect(decodedValue.value(for: \.stringP)) == "Value P"
                            } catch {
                                fail("Should not throw: \(error)")
                            }
                        }
